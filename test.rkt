...
(check-equal? (min-list-val '() 92337203654775807) #F)
...
(check-equal? (min-above-min '(100) '()) 100)
(check-equal? (min-above-min '(a 200 b 100 c 300 d) '()) 100)
(check-equal? (min-above-min '(a) '(a 200 b 100 c 300 d)) #F)
